...
SET /P ANSWER="Are you serious? If you proceed, all user data (photos, app data, etc.) on the connected device will be deleted. Only proceed if you know what you are doing. (y or any other key): "
